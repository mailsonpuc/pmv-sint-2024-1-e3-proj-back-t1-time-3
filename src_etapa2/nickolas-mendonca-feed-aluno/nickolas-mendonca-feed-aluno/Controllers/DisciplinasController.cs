...
namespace nickolas_mendonca_feed_aluno.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Resumo")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Resumo")] Disciplina disciplina)
        {
            if (id != disciplina.Id)
            {
                return NotFound();
